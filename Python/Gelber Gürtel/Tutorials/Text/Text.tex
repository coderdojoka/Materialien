...
Um die Länge, die Anzahl der Buchstaben, eines Textes zu ermitteln, benutzt man \code{len(...)} wie folgt:
...
\begin{merkbox}
\textbf{Achtung:} Beim Programmieren fangen wir immer an bei \code{0} zu zählen.
Das heißt, dass wenn wir den dritten Buchstaben erfahren wollen, wir \code{2} in die eckigen Klammern schreiben müssen.
\end{merkbox}
